...
to find out which questions practitioners most want answered [@Begel2014].
...
-   Reminder: research on people requires ethical oversight,
    ...
    -   Review [earlier discussion](../qualitative/index.qmd)
...
-   [@Sedano2017]'s nine waste categories are a useful starting checklist 
...
-   The {{<g gqm "Goal-Question-Metric (GQM)" >}} approach
    provides a structured path from intent to measurement [@Basili1994]
    -   Define the goal:
...
-   Careful qualitative work can produce taxonomies that guide GQM measurement:
    -   [@Sillito2008] analyzed programmers during change tasks
        and produced a catalog of 44 question types that developers ask
        when navigating an unfamiliar codebase
    -   [@Ko2007] observed 17 developers at a large software company
