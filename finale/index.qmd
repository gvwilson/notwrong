...
or the configuration that minimizes defects—and solved with optimization algorithms [@Harman2001].
...
-   A foundational finding underlies most AI code generation:
    [@Hindle2016] showed that code is statistically more repetitive and predictable
