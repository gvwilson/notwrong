...
<span id="ab_testing">A/B testing</span>
...
<span id="axial_coding">axial coding</span>
...
<span id="blinding">blinding</span>
...
<span id="blocking_variable">blocking variable</span>
...
<span id="boredom_effect">boredom effect</span>
...
<span id="change_failure_rate">change failure rate</span>
...
<span id="conclusion_validity">conclusion validity</span>
...
<span id="confirmatory_analysis">confirmatory analysis</span>
...
<span id="confounding_variable">confounding variable</span>
...
<span id="convenience_sampling">convenience sampling</span>
...
<span id="dependent_variables">dependent variable</span>
...
<span id="deployment_frequency">deployment frequency</span>
...
<span id="difference_in_differences">difference-in-differences</span>
...
<span id="double_blind_study">double blind study</span>
...
<span id="empirical_software_engineering">empirical software engineering</span>
...
<span id="experience_sampling">experience sampling method</span>
...
<span id="exploratory_analysis">exploratory analysis</span>
...
<span id="external_validity">external validity</span>
:   The degree to which study findings generalize beyond the specific sample,
    setting, and task studied.

## F

<span id="file_drawer_problem">file drawer problem</span>
...
<span id="gerund_coding">gerund coding</span>
...
<span id="goodharts_law">Goodhart's Law</span>
...
<span id="grounded_theory">grounded theory</span>
...
<span id="hawthorne_effect">Hawthorne effect</span>
...
<span id="independent_variables">independent variable</span>
:   The variable that is manipulated or selected by the researcher to
    examine its effect on an outcome.

<span id="informed_consent">informed consent</span>
...
<span id="intercoder_reliability">intercoder reliability</span>
...
<span id="internal_survey">internal survey</span>
...
<span id="internal_validity">internal validity</span>
...
<span id="interrupted_time_series">interrupted time series</span>
...
<span id="lead_time_for_change">lead time for change</span>
...
<span id="longitudinal_study">longitudinal study</span>
...
<span id="maturation_effect">maturation effect</span>
...
<span id="meta_analysis">meta-analysis</span>
...
<span id="msr">mining software repositories (MSR)</span>
...
<span id="natural_experiment">natural experiment</span>
...
<span id="non_response_bias">non-response bias</span>
...
<span id="novelty_effect">novelty effect</span>
...
<span id="nuisance_variable">nuisance variable</span>
...
<span id="null_hypothesis">null hypothesis</span>
...
<span id="operationalization">operationalization</span>
...
<span id="order_effects">order effects</span>
...
<span id="overgeneralization">overgeneralization</span>
...
<span id="preregistration">pre-registration</span>
...
<span id="preprint">preprint</span>
...
<span id="proxy_metric">proxy metric</span>
...
<span id="qualitative_methods">qualitative methods</span>
...
<span id="randomization">randomization</span>
...
<span id="sampling_strategy">sampling strategy</span>
...
<span id="semi_structured_interview">semi-structured interview</span>
...
<span id="single_blind_study">single blind study</span>
...
<span id="social_desirability_bias">social desirability bias</span>
...
<span id="statistical_power">statistical power</span>
:   The probability that a study will detect an effect if one truly exists;
    conventionally targeted at 0.80.

<span id="statistical_significance">statistical significance</span>
...
<span id="stratified_sampling">stratified sampling</span>
...
<span id="structured_interview">structured interview</span>
...
<span id="treatment_group">treatment group</span>
...
<span id="triangulation">triangulation</span>
:   The use of multiple data sources, methods, or investigators to increase
    confidence in a finding.

## U

<span id="unconscious_formalization">unconscious formalization</span>
...
<span id="unstructured_interview">unstructured interview</span>
...
<span id="winners_curse">winners curse</span>
...
<span id="within_subjects_design">within subjects design</span>
