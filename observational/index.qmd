...
"The Promises and Perils of Mining GitHub" [@Kalliamvakou2014].
...
-   Munaiah et al. address the noise problem directly:
    ...
    achieving 82% precision and 86% recall [@Munaiah2017]
-   MSR studies can also challenge received wisdom:
    ...
    not during later evolution, and that 80% survive indefinitely [@Tufano2017]
...
-   A study of Mylyn (a task-focused IDE plugin) recruited 99 developers,
    ...
    -   The 6:1 funnel was reported honestly and shaped interpretation of the results
        [@Sadowski2019]
-   Beller et al. tracked 416 developers over five months using IDE instrumentation [@Beller2015]:
