...
[@Abad2018] combined longitudinal analysis of 4,910 recorded tasks from 17 professional
...
[@Beller2018] combined an online survey of 176 developers with IDE instrumentation of 458 developers
...
[@Girardi2020] showed that developer emotions can be reliably recognized during programming tasks
...
[@Meyer2021] characterized what makes a workday "good" and "typical."
...
[@Newman2023] surveyed and interviewed professional programmers about psychoactive substance use —
...
[@Obi2024] identified the most common sources of "bad days" in software development.
...
[@Stapleton2020] studied 45 students and professional developers reading Java methods with either
...
[@Tregubov2017] found that developers working on two or more concurrent projects spend
...
[@Wyrich2023] reviews the empirical literature on program comprehension and proposes a contemporary
...
[@AlencarDaCosta2017] developed a framework for evaluating implementations of the SZZ algorithm,
...
[@Aniche2021] observed 13 developers thinking aloud while writing tests for real-world open-source
...
[@Aranda2009] showed that written bug reports frequently omit important causal factors
...
[@Basili1987]'s controlled experiment compared code reading, functional testing,
...
[@Bogart2016] studied how developers in Eclipse, CRAN, and npm ecosystems negotiate breaking API changes,
...
[@ElEmam2001] showed that class size is a significant confounder when validating object-oriented metrics
...
[@Fucci2013] found that how closely developers adhere to TDD practices matters more for outcomes
...
[@Inozemtseva2014] studied the correlation between code coverage and fault detection across
...
[@Silva2016] compiled a catalogue of 44 motivations for 12 common refactoring types.
...
[@Spinellis2024] empirically tested the "broken windows" theory in software by examining whether
...
[@Thongtanunam2016] extended traditional code ownership metrics by incorporating reviewing activity
...
[@Bird2011] examined code ownership in Windows Vista and Windows 7 by measuring the number of
...
Using a large GitHub dataset, [@Gote2022] tested whether adding developers to a project
...
[@Mockus2010] studied how personnel changes — departures, role changes, and organizational restructuring —
...
[@Nagappan2008] quantified organizational complexity
...
[@Brown2024] examined how open source development data — commit rates, contributor counts, project activity —
...
modeling, [@Flournoy2025] found that coding days per week, merged pull request counts,
...
[@Junior2009] reviewed productivity measurement approaches in software organizations and proposed
...
[@SanchezRuiz2023] argued that standard DORA metrics cannot be directly applied to open source projects
...
[@Davis2023] systematically reviewed programmer user studies and identified recurring methodological
...
[@FernandezPinto2023] argues that industry funding and practitioner collaboration
...
[@Gold2020] examined the ethical implications of mining software repositories for research,
...
[@Storey2024] is a practical guide to mixed methods research in software engineering,
...
[@Uyaguari2024] analyzed published TDD experiments and identified common omissions in reporting
...
[@Bano2025] probed several large language models with questions about what a software engineer
...
[@Bouzenia2025] analyzes the thought-action-result trajectories of three LLM-based software
...
[@Fu2025] analyzed Copilot-generated code committed to real GitHub projects and found a high rate
...
[@Miller2025] studied why developers adopt or avoid generative AI coding tools,
...
[@Butler2023] conducted semi-structured interviews with 47 participants and a survey of over
...
[@Maalej2014] found that developers follow pragmatic, context-driven comprehension strategies
...
[@Ray2017] analyzed 728 GitHub projects spanning 17 programming languages and over 63 million lines
