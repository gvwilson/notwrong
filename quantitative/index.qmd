...
a study of test-driven development [@Erdogmus2005].
...
-   Construct validity: does your measurement actually capture the concept you care about?
    -   Discussed [earlier](../productivity/index.qmd)
...
-   Internal validity:
    ...
    -   SE-specific behavioral threats, which arise because people are the experimental subjects:
        -   Novelty effect (discussed [earlier](../wrong/index.qmd))
...
-   All of the consideration from [the previous lesson](../qualitative/index.qmd) apply
...
*See [the appendix on statistics](../stats/index.qmd) for a worked example before trying this exercise.*
...
Read the methods section of [@Erdogmus2005].
