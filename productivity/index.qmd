...
and Efficiency and flow [@Forsgren2021].
...
-   Most of a developer's time is not spent writing code:
    ...
    -   Meetings, email, and coordination consumed most of the rest [@Meyer2017]
...
he had replaced 2000 lines with a faster, shorter algorithm [@Sadowski2019].
...
-   The DevOps Research and Assessment (DORA) program identified four
    metrics that correlate with organizational performance [@Forsgren2018]:
...
-   Developer well-being is both a dimension of productivity and a precondition for it:
    -   A survey of 1,318 developers found that
        ...
        and reduced code quality [@Graziotin2018]
    -   A lab study using biometric sensors found that developers' emotions
        correlate with their perceived progress on change tasks [@Muller2015],
...
-   A two-and-a-half-year study at Pivotal identified nine waste categories:
    ...
    knowledge loss,
    and ineffective communication [@Sedano2017]
