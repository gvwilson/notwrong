...
-   Mixed-methods studies use both, which is more expensive but often more informative
    -   E.g., [%b Brandt2009 %] combined a lab experiment with query log analysis
        to understand how programmers use web resources while coding
    -   Lab study identified the range of purposes (learning, reminding, extending knowledge);
        log data confirmed those patterns appeared in real-world searches
