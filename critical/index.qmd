...
In 2023,
McKinsey published "Yes, You Can Measure Software Developer Productivity" [@McKinsey2023].
...
made by people with interests [@Beck2023].

The gap between belief and evidence runs deep.
[@Devanbu2016] studied developers at Microsoft
...
-   The GitHub Copilot study [@Peng2023] was conducted by GitHub employees
...
-   The same trap appears in ML research:
    ...
    yet context is almost always required to make a real vulnerability call [@Risse2025]
...
-   Organizing questions around the four validity categories
    ...
    [@Campbell1963; @Wohlin2000; @Juristo2001]
-   Conclusion validity:
...
which would require p < 0.004 for any individual test)
...
Apply the checklist from this lesson to [@Peng2023] or [@McKinsey2023].
For each item,
